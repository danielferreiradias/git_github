...
| git log | Check logs of your alterations, use "-p" flag to see a particular alteration of your archive. Use the "--online" flag to see in an shorter visualization |
